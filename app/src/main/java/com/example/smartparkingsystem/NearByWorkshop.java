...
public class NearByWorkshop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_near_by_workshop);
        mProgressBarsaving = new ProgressDialog(NearByWorkshop.this);
        mProgressBarsaving.setMessage("Loading. . .!");
        mProgressBarsaving.show();
        recyclerView = findViewById(R.id.nbWorkshop_recycler);
        ...
        editor.putString("parentbooking","workshop");
        editor.apply();



        query= FirebaseDatabase.getInstance().getReference().child("NearBy").child("Workshops").orderByChild("p_space");
